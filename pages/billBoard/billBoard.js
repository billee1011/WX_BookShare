...
Page({
    ...
    onLoad() {
        ...
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=User&a=getTopInvite&id=' + app.globalData.userId).replace(/\s+/g, ""),
            method: "GET",
            dataType: "json",
    ...
    getInviteCode:function(){
        var that = this;
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=User&a=createInvite&id=' + app.globalData.userId).replace(/\s+/g, ""),
            method: "GET",
            dataType: "text",
            success: function (res) {
                if (res.data != "fail") {
