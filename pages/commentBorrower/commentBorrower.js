...
Page({
    ...
    comment: function () {
        ...
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=Api&a=borrowComment&sharingId=' + that.data.sharingId + "&borrower_attitude=" + that.data.key1 + "&book_protect=" + that.data.key2 + "&borrower_content=" + that.data.card_content).replace(/\s+/g, ""),
            method: "GET",
            header: {
                'content-type': 'application/json'
            },
