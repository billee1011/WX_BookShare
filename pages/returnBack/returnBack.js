...
Page({
    ...
    onLoad: function () {
        var that = this;
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=Api&a=getReturnBack&userId=' + app.globalData.userId).replace(/\s+/g, ""),
            method: "GET",
            header: {
    ...
    borrowAffirmReturn: function (e) {
        ...
        var that = this;
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=Api&a=returnBack&sharingId=' + sharingId + "&canShareId=" + canShareId).replace(/\s+/g, ""),
            method: "GET",
            header: {
                'content-type': 'application/json'
            },
