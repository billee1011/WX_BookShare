...
Page({
    ...
    shareBook:function(){
        ...
        wx.request({
            url: ( app.globalData.apiUrl + '?m=home&c=Api&a=shareBook&ownerId=' + app.globalData.userId + "&bookId=" + that.data.bookId + "&keep_time=" + that.data.uploadDays + "&location=" + that.data.location + "&longitude=" + that.data.longitude + "&latitude=" + that.data.latitude).replace(/\s+/g, ""),
            method: "GET",
            header: {
                'content-type': 'application/json'
            },
