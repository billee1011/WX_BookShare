...
Page({
    ...
    toAuth: function (e) {
        ...
        if (that.data.changePic == "true" || that.data.changePic || that.data.changePic==true){
            ...
            wx.uploadFile({
                url:  app.globalData.apiUrl + '/index.php?m=home&c=User&a=selfAuth',
                header: {
    ...
    //     wx.request({
    //         url: ( app.globalData.apiUrl + '/index.php?m=home&c=User&a=selfAuth&ID=' + app.globalData.userId + "&userName=" + that.data.userName + "&userSchool=河北工业大学&userClass=河北工业大学计算机学院&studentCard=000000&eMail=" + that.data.eMail + "&phoneNumber=" + that.data.phoneNumber).replace(/\s+/g, ""),
    //         method: "get",
    //         dataType: "json",
    //         success: function (res) {
    //             var data = res.data
